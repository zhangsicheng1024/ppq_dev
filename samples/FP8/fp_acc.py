...
from ppq.samples.QAT.trainer import ImageNetTrainer
...
collate_fn1  = lambda x: x.to('cuda')
...
with ENABLE_CUDA_KERNEL():
    ...
    graphwise_error_analyse(
        ...
        dataloader=eval_dataloader, collate_fn=collate_fn)

    # trainer = ImageNetTrainer(graph=graph)
    current_acc = trainer.eval(eval_dataloader)
    print("test Top1: {}".format(current_acc))
# ------------------------------------------------------------
# 在最后，我们导出计算图
